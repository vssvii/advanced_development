...
//        let image: String?
    ...
    override func viewDidLoad() {
        ...
        posts = [
            Post(author: "dimash_kudaibergen".localized, description: "concert_in_moscow".localized, image: UIImage(named: "dimash"), likes: 150, views: 200),
            Post(author: "elon_musk".localized, description: "launching_global_wi-fi".localized, image: UIImage(named: "starlink"), likes: 400, views: 450),
            Post(author: "motivation_sport".localized, description: "pushups_program".localized, image: UIImage(named: "pushups"), likes: 150, views: 180),
            Post(author: "films".localized, description: "avatar_the_way_of_water".localized, image: UIImage(named: "avatar"), likes: 300, views: 400),
            Post(author: "football".localized, description: "chelsea_in_final".localized, image: UIImage(named: "chelsea"), likes: 400, views: 500),
            Post(author: "travel".localized, description: "switzerland".localized, image: UIImage(named: "travel"), likes: 450, views: 500)
        ]
