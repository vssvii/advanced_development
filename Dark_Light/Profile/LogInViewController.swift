...
class LogInViewController: UIViewController {
    ...
    public lazy var login: UITextField = {
        ...
        login.placeholder = "login_or_email".localized
//        login.delegate = self
...
//        pass.delegate = self
    ...
    private lazy var signUpButton: UIButton = {
        ...
        changeButton.setTitle("sign_up".localized, for: .normal)
...
//                isAuthorized = true
                ...
                checkInLabel.text = "incorrect_password".localized
    ...
    func isAuthorized() {
        ...
        for authObject in authObjects {
            if authObject.userName != nil {
                ...
                print("not_authorized".localized)
            }
        }
    }
...
//        authRealm.isUserAuthorized = false
        ...
        presentAlert(title: "", message: "success_registration".localized)
    ...
    override func viewDidLoad() {
        ...
        scrollView.backgroundColor = .blackWhiteColor
        contentView.backgroundColor = .blackWhiteColor
