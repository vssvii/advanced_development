...
class PostTableViewCell: UITableViewCell {
    ...
    public lazy var authorLabel: UILabel = {
        ...
        authorLabel.textColor = .whiteBlackColor
    ...
    public lazy var descriptionLabel : UILabel = {
        ...
        descriptionLabel.textColor = .whiteBlackColor
    ...
    public lazy var likesLabel : UILabel = {
        ...
        likesLabel.textColor = .whiteBlackColor
    ...
    public lazy var viewsLabel : UILabel = {
        ...
        viewsLabel.textColor = .whiteBlackColor
